...
public interface WgCollection<E> extends WgIterator<E> {
    int size();
     ...
     *         ({@linkplain java.util.Collection##optional-restrictions optional})
     ...
     * {@link WgIterator#remove()}.  If the collection's iterator does not
    ...
    default boolean removeIf(Predicate<? super E> filter) {
        ...
        final WgIterator<E> each = iterator();
        while (each.hasNext()) {
